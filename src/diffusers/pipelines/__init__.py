...
try:
    ...
    _import_structure["z_image"] = ["ZImageImg2ImgPipeline", "ZImageInpaintPipeline", "ZImagePipeline"]
...
if TYPE_CHECKING or DIFFUSERS_SLOW_IMPORT:
    ...
    try:
        ...
        from .z_image import ZImageImg2ImgPipeline, ZImageInpaintPipeline, ZImagePipeline
